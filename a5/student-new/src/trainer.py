...
# 因为 trainer 需要的参数太多了，所以不方便在 trainer 的 init 里面写着么多，所以单独开一个类
# 同时因为这是一个类，所以当前 trainer 的参数还可以进行移植，很方便
class TrainerConfig:
...
class Trainer:
    ...
    def train(self):
        ...
        def run_epoch(split):
            ...
            # 我们初始化 trainer 的时候传入的就是一行极长的字符串，之后我们需要用 Dataloader 来让数据 batched
